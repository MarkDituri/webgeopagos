...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-11-2022 a las 23:51:06
...
INSERT INTO `carrito_temp` (`id_carrito_temp`, `status`, `code_session`, `total`, `activo`, `qr`, `datecreated`, `id_restaurante`) VALUES
(1, '2', 'ma2zev', 2300, 'si', '', '2022-10-03 17:02:52', 1),
(2, '2', 'sNGPT0', 250, 'si', 'si', '2022-10-03 17:03:12', 1),
(3, '2', 'ui2GS0', 2400, 'si', 'si', '2022-10-03 17:03:31', 1),
(4, '2', 'fgTVZc', 1400, 'si', 'si', '2022-10-03 17:03:53', 1),
(5, '0', 'qQxC4c', NULL, 'si', 'si', '2022-10-03 17:04:13', 1);
...
INSERT INTO `notificaciones` (`id_notificacion`, `status`, `tipo`, `titulo`, `id_pedido`, `id_restaurante`, `code_session`) VALUES
(1, 1, 'PUSH', NULL, NULL, 1, 'ma2zev'),
(2, 1, 'PUSH', NULL, NULL, 1, 'sNGPT0'),
(3, 1, 'PUSH', NULL, NULL, 1, 'ui2GS0'),
(4, 1, 'PUSH', NULL, NULL, 1, 'fgTVZc');
...
(2, 0, '2023-01-21', '2023-02-05  ', '2023-02-21', NULL, 790, NULL, NULL, NULL, 'si', 2, 1);
...
INSERT INTO `pedidos` (`id_pedido`, `status`, `detalle`, `code_session`, `cantidad`, `precio`, `id_producto`, `id_restaurante`) VALUES
(1, NULL, '', 'ma2zev', 0, 2300, 1, 1),
(2, NULL, '', 'sNGPT0', 0, 250, 6, 1),
(3, NULL, '', 'ui2GS0', 0, 2400, 4, 1),
(4, NULL, '', 'fgTVZc', 0, 1400, 10, 1);
...
(1, '1tloe4158', 'Qudimar', 'qudimarMAX', 'Menu', 11308784672, 'mcc.qudimar@gmail.com', '64001bd1f8f492db2e446d4c2d39062a3aade19c32acd21ffaf7a013468c1121', NULL, NULL, NULL, 'fedb1f134afd2327917d', 1, 'portada.png', '', '', '', '', 7, 0, '', '', '2022-07-26 19:19:55', 1, 2, 0);
...
--
ALTER TABLE `carrito_temp`
  MODIFY `id_carrito_temp` bigint(250) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `notificaciones`
  MODIFY `id_notificacion` bigint(250) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `pagos`
--
ALTER TABLE `pagos`
  MODIFY `id_pago` bigint(250) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `pedidos`
--
ALTER TABLE `pedidos`
  MODIFY `id_pedido` bigint(250) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `productos`
  MODIFY `id_producto` bigint(250) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de la tabla `restaurantes`
--
ALTER TABLE `restaurantes`
  MODIFY `id_restaurante` bigint(250) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
